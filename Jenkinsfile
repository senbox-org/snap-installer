...
pipeline {
    ...
    parameters {
        string(name: 'smosBoxBranch', defaultValue: "7.0.0-rc3", description: 'Smos-box branch to use to build installer')
        string(name: 'probavboxBranch', defaultValue: "7.0.0-rc3", description: 'Probavbox branch to use to build installer')
    }
    stages {
